    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[320px] md:h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full text-center">
          <Link href="/" className="inline-block text-gray-100 hover:text-white transition-colors duration-300 text-lg mb-4">
            ← ホームに戻る
          </Link>
          <h1 className="text-3xl md:text-5xl font-bold text-white drop-shadow-lg mt-4">イベント開催日程</h1>
        </div>
      </section>
