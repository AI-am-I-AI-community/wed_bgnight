          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-up">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-slate-400 rounded-full"></div>
                  <span className="text-slate-600"><strong>特性:</strong> ADHD（診断済み）</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12">
              <div className="card hover-lift">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">「第二の自分」プロジェクト開始</h3>
                    <p className="text-slate-600 leading-relaxed">
                      ChatGPTを自分の分身として育てる独自手法を開発。音声思考整理とAI対話を組み合わせた
                      自己理解促進システムを構築。3ヶ月の実践で大きな効果を実感し、メソッド化を開始。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card hover-lift">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">コミュニティ活動の本格化</h3>
                    <p className="text-slate-600 leading-relaxed">
                      毎週水曜日「ボードゲーム制作会」を主催開始。福岡での国際交流イベント、
                      AI勉強会の企画・運営を通じて、人と人をつなぐ場づくりに情熱を注ぐ。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card hover-lift">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">クリエイティブ活動の拡大</h3>
                    <p className="text-slate-600 leading-relaxed">
                      3Dモデリング（Blender）、Vtuber活動（ティキちゃん）、音楽制作など
                      多岐にわたるデジタルコンテンツ制作に挑戦。ADHD特性を活かした独自のアプローチを確立。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card hover-lift">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">AI活用サポートの体系化</h3>
                    <p className="text-slate-600 leading-relaxed">
                      個人の経験をもとに、AI×自己理解のコーチング手法を体系化。
                      フリーランサーや創作者向けのメンタリングサービスを開始し、
                      「やらぬ善よりやる偽善」の精神で実践的支援を提供。
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">3Dモデリング・制作</h3>
              <p className="text-slate-600 text-sm">Blender、3Dプリンター、デジタルアート</p>
            </div>
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">ゲーム開発</h3>
              <p className="text-slate-600 text-sm">ボードゲーム制作、ゲームデザイン</p>
            </div>
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">音楽・表現活動</h3>
              <p className="text-slate-600 text-sm">ギター演奏、ヨーヨー、ドローン撮影</p>
            </div>
          </div>
        </div>
      </section>
